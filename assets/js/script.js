/**
 * Zuwad Plugin - Main Script
 * 
 * This file manages the core functionality of the Zuwad plugin including:
 * - User management forms and modals
 * - Country codes and phone formatting
 * - AJAX operations for user data
